...
public class JwtUtil {
    ...
    private Boolean isTokenExpired(String token) {
        return extractExpiration(token).before(new Date()); // Compara la fecha de expiración del token con la fecha y
                                                            // hora actuales
    }
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        // Compara el nombre de usuario extraído con el del UserDetails y verifica si el
